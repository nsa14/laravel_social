...
<head>
    ...
    <title>Dashboard - Bootstrap Admin Panel </title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('index')}}">پنل مدیریت</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="{{ route('logout') }}"
                            ...
                            document.getElementById('logout-form').submit();">
                             <i class="fa fa-sign-out fa-fw"></i> {{ __('خروج') }}
                          </a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-instagram"></i> اینستاگرام <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ route('instagram-list') }}"><i class="fa fa-table fa-fw"></i> لیست شبکه اینستاگرام</a>
                                </li>
                                <li>
                                    <a href="{{ route('instagram-add') }}"><i class="fa fa-table fa-fw"></i> رکورد جدید </a>
                                </li>
                                <li>
                                    {{-- <a href="{{ route('instagram-updating') }}"><i class="fa fa-table fa-fw"></i> بروزرسانی لیست </a> --}}
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-heart"></i> لایکی <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ route('likee-list') }}"><i class="fa fa-table fa-fw"></i> لیست شبکه لایکی</a>
                                </li>
                                <li>
                                <a href="{{ route('likee-insert-show') }}"><i class="fa fa-table fa-fw"></i> رکورد جدید </a>
                                </li>
                                {{-- <li>
            ...
            <div class="row">
                ...
                @if ( Route::currentRouteName() == "index")
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="canvas-wrap">
                            <canvas id="c"></canvas>
                            <div id="overlay">@yield('content')</div>
                        </div>                    
