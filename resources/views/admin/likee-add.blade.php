...
@section('content')
<h1 class="page-header">درج رکورد جدید لایکی </h1>
            <!-- /.row -->
                ...
                <div class="col-lg-4">
                    <div class="well">
                        <h4>* رکورد تکراری قابل ثبت نمی باشد  
                            .
                            <p>* هر ای دی را در یک خط نوشته و حداکثر میتواند تا 50 رکورد را واکشی نماید و زمان تقریبی هر رکورد 
                                4 ثانیه می باشد.
                            </p>
                        </h4>
                        <p>
                            <form role="form" action="{{ route('likee-insert') }}" id="form" method="POST">
                                @csrf
