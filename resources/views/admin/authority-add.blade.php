...
@section('content')
<h1 class="page-header">درج رکورد جدید authority </h1>
            <!-- /.row -->
                ...
                <div class="col-lg-6">
                    <div class="well">
                        <h4>* رکورد تکراری قابل ثبت نمی باشد  
                            ...
                            <p>اطلاعات دریافتی شامل : Domain Authority, Linking Root Domains, Ranking Keywords</p>
                        </h4>
                        <p>
                            <form role="form" action="{{ route('authority-checker') }}" id="form-alexa" method="POST">
                                @csrf
